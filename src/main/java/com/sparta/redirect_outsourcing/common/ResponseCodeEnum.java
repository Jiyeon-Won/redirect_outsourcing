...
public enum ResponseCodeEnum {
    ...
    // 팔로우
    ALREADY_FOLLOWED(HttpStatus.CONFLICT, "이미 팔로우를 등록한 상태입니다."),
    ALREADY_UN_FOLLOWED(HttpStatus.CONFLICT, "이미 팔로우를 삭제한 상태입니다."),
    FOLLOW_SELF(HttpStatus.FORBIDDEN, "자신에게는 팔로우 기능을 이용할 수 없습니다."),
